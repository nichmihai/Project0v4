    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            try {
                ...
                while (option != 0)
                {
                    ...
                    if (option == 15)
                    {
                        bankAccount.TransferFromCdToChK();
                        ShowMenu();
                        option = Int32.Parse(Console.ReadLine());
                    }
        ...
        public static void ShowMenu()
        {
            Console.WriteLine("\nPlease choose one of the options" +
                              ...
                              "\n9. Pay loan" +
                              "\n10. Create a temporary deposit" +
                              "\n11. Withdraw money from Temporary Account" +
                              "\n12. Show the accounts!" +
                              "\n13. Transfer from Checking Account to Business Account" +
                              "\n14. Transfer from Business Account to Checking Account" +
                              "\n15. Transfer from Temporary to Checking Account" +
                              "\n16. Close Checking Account" +
                              "\n17. Close business Account" +
                              "\n18. Close business Account");
        }
    }
}